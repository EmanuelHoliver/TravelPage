...
export default function Footer() {
  return (
    <>
      <footer className="text-center bg-gray-900 text-white  px-6 mx-auto">
        <div className="container my-24 px-6 mx-auto pt-6">
        ...
        >
          © 2023 Copyright: 
          <a className="text-white" href="https://www.linkedin.com/in/emanuel-oliveira-2409aa179/">
           Emanuel Heitor de Oliveira
          </a>
        </div>
      </footer>
    </>
